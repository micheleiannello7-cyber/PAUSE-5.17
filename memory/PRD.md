...
- Per completarle servirebbe rigenerarle con AI (Gemini image), che consuma credito Emergent LLM — decisione lasciata all'utente. In alternativa l'utente può fornire i file immagine da mettere in `backend/covers/<id>.webp`.
